...
ALTER TABLE "personal_season" ADD COLUMN "personal_show_id" uuid;--> statement-breakpoint
ALTER TABLE "personal_season" ALTER COLUMN "canonical_show_id" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "personal_season" ALTER COLUMN "canonical_season_id" DROP NOT NULL;--> statement-breakpoint
