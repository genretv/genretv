...
describe("genretv sync registry", () => {
  test("declares the public canonical schedule shapes", () => {
    ...
    expect(genretvSyncRegistry.canonical_episode.writeMode).toBe("optimistic");
    expect(genretvSyncRegistry.canonical_show.mode).toBe("readwrite");
    expect(genretvSyncRegistry.canonical_show.writeMode).toBe("optimistic");
    expect(genretvSyncRegistry.canonical_season.mode).toBe("readwrite");
    expect(genretvSyncRegistry.canonical_season.writeMode).toBe("optimistic");
    ...
    expect(genretvSyncRegistry.personal_show.writeMode).toBe("optimistic");
    ...
    expect(genretvSyncRegistry.personal_season.writeMode).toBe("optimistic");
    ...
    expect(genretvSyncRegistry.personal_episode.writeMode).toBe("optimistic");
    ...
    expect(genretvSyncRegistry.personal_list_exclusion.writeMode).toBe("optimistic");
