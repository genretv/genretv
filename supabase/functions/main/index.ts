...
Deno.serve(async (req: Request) => {
  ...
  // Per-worker wall-clock budget. Sync proxies hold Electric long-polls open continuously: at the stock
  // 60s a long-poll worker can be recycled mid-cycle. A larger budget makes that churn rare.
  // Unset means the stock 60s.
